 ...
 * @author Zi Wei Fan
 */
public class MarketManageEmployee extends javax.swing.JPanel {

    private OrganizationDirectory organizationDir;
    private JPanel userProcessContainer;

    public MarketManageEmployee(JPanel userProcessContainer, OrganizationDirectory organizationDir) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(organizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 100, 230, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 150, 630, 300));
        ...
        add(organizationEmpJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 480, 250, -1));

        nameJTextField.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        add(nameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 530, 250, -1));

        jLabel2.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        jLabel2.setText("Name:");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 530, -1, -1));

        addJButton.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        addJButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FeedbackAnalytics/Picture/user.png"))); // NOI18N
        ...
        add(addJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 600, -1, -1));
