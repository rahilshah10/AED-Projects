...
public class SearchForProductJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 190, -1, 52));

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("Product Id");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 280, -1, -1));

        txtId.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 310, 250, -1));
        ...
        add(btnSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 310, 160, -1));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 400, -1, -1));
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        p = supplier.getPc().searchProduct(productId);
        if(p!=null){
