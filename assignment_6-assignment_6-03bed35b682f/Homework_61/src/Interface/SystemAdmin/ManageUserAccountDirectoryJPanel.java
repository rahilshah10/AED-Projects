...
public class ManageUserAccountDirectoryJPanel extends javax.swing.JPanel {
    ...
    public ManageUserAccountDirectoryJPanel(JPanel userProcessContainer, Business business, UserAccount userAccount) {
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    for (int i = rowCount - 1; i >= 0; i--) {
        ...
        {
            String str="";
            if(u.getUserName()=="" && u.getPassWord()==str.hashCode())
            {
            continue;
            }
            else
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
     ...
     UserAccount u = business.getUserDirectory().searchAccount(search);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(dialogResult == JOptionPane.YES_OPTION)
        {
            ...
            business.getUserDirectory().deleteAccount(u);
            populateTable();
        }
        }
